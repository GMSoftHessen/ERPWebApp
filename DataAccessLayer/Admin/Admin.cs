...
namespace DataAccessLayer.Admin
{
    ...
    public class AdminDbContext : System.Data.Entity.DbContext, IAdminDbContext
    {
        ...
        {
            System.Data.Entity.Database.SetInitializer<AdminDbContext>(null);
        }
        ...
        public AdminDbContext(string connectionString, System.Data.Entity.Infrastructure.DbCompiledModel model)
            : base(connectionString, model)
        {
        }

        public AdminDbContext(System.Data.Common.DbConnection existingConnection, bool contextOwnsConnection)
            : base(existingConnection, contextOwnsConnection)
        {
        }

        public AdminDbContext(System.Data.Common.DbConnection existingConnection, System.Data.Entity.Infrastructure.DbCompiledModel model, bool contextOwnsConnection)
            : base(existingConnection, model, contextOwnsConnection)
        {
        }

        public AdminDbContext(System.Data.Entity.Core.Objects.ObjectContext objectContext, bool dbContextOwnsObjectContext)
    ...
    public class AdminDbContextFactory : System.Data.Entity.Infrastructure.IDbContextFactory<AdminDbContext>
    {
        public AdminDbContext Create()
        {
    ...
    public class Group
    {
        ...
        /// <summary>
        /// Child Users where [User].[Group_Id] point to this entity (FK_User_Group)
        /// </summary>
    ...
    public class UserConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<User>
    {
        ...
        public UserConfiguration(string schema)
        {
            ...
            Property(x => x.UserName).HasColumnName(@"UserName").HasColumnType("varchar").IsRequired().IsUnicode(false).HasMaxLength(20);
            Property(x => x.Password).HasColumnName(@"Password").HasColumnType("varchar").IsRequired().IsUnicode(false).HasMaxLength(100);
            Property(x => x.Email).HasColumnName(@"Email").HasColumnType("varchar").IsRequired().IsUnicode(false).HasMaxLength(100);
            Property(x => x.Picture).HasColumnName(@"picture").HasColumnType("varchar").IsOptional().IsUnicode(false).HasMaxLength(100);
            Property(x => x.GroupId).HasColumnName(@"Group_Id").HasColumnType("int").IsRequired();

            // Foreign keys
            HasRequired(a => a.Group).WithMany(b => b.Users).HasForeignKey(c => c.GroupId).WillCascadeOnDelete(false); // FK_User_Group
        }
    }
