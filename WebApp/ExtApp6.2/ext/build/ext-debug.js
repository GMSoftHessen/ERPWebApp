...
Ext.Base = function(flexSetter) {
  ...
  Ext.apply(Base, {$className:'Ext.Base', $isClass:true, create:function() {
    ...
    var me = this, mixin, prototype, key, statics, i, ln, mixinName, name, mixinValue, mixins, mixinStatics, staticName;
    if (typeof name !== 'string') {
      mixins = name;
...
(Ext.env || (Ext.env = {})).Browser = function(userAgent, publish) {
  ...
  '', majorVer = '', isWebView = false, edgeRE = /(Edge\/)([\w.]+)/, i, prefix, mode, name, maxIEVersion;
...
Ext.define('Ext.overrides.dom.Element', function() {
  ...
  false, BODY:Ext.isIE ? false : true}, naturallyTabbableTags:{BUTTON:true, IFRAME:true, INPUT:true, SELECT:true, TEXTAREA:true, OBJECT:Ext.isIE8m ? true : false}, tabbableSavedCounterAttribute:'data-tabindex-counter', tabbableSavedValueAttribute:'data-tabindex-value', normalize:function(prop) {
    ...
    var me = this, dom = me.dom, data = me.getData(true), maskEl, maskMsg;
    if (dom) {
      if (me.isAnimate) {
        me.stopAnimation();
      }
    ...
    beforeAnim = function() {
      animFly.attach(dom);
      var animScope = this, listeners = obj.listeners, box, originalStyles, anim, wrap;
      if (!slideOut) {
        animFly.fixDisplay();
      }
      box = animFly.getBox();
  ...
  Ext.onInternalReady(function() {
    var transparentRe = /^(?:transparent|(?:rgba[(](?:\s*\d+\s*[,]){3}\s*0\s*[)]))$/i, origSetWidth = proto.setWidth, origSetHeight = proto.setHeight, origSetSize = proto.setSize, pxRe = /^\d+(?:\.\d*)?px$/i, colorStyles, i, name, camel;
